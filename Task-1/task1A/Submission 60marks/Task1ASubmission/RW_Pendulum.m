...
I1=m1*l1*l1;#pendulum ineria
I2=m2*wr*wr;#reaction wheel ineria
...
function [A, B] = RW_pendulum_AB_matrix(m1 , m2, l1, wr, g)
  I1= m1*l1*l1;  # Moment of Inertia of pendulum bar
  I2=m2*wr*wr ; # Moment of Inertia of reaction wheel
  A = [0 1 0 0; I2*m1*g/(I1*I2-I2*I2) 0 0 0;0 0 0 1;-I2*m1*g/(I1*I2-I2*I2) 0 0 0];
